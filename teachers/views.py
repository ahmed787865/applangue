...
from .forms import teacherForm, EditteacherForm, UserForm, langueForm, EditlangueForm
...
def createTeacher(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            teacher.save()
            return redirect('Allteachers')  # Redirect to a view displaying the list of clients
    else:
        form = teacherForm()
...
class Editteacher(UpdateView):
    ...
    success_url = reverse_lazy('Allteachers')
